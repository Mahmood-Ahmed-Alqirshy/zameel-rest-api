<mail::message>
  ...
  <head>
    ...
    <title>زميل | تأكيد البريد الالكتروني</title>
    <style>
  ...
  <body class="p-10 grid place-items-center bg-indigo-50/25" dir="rtl">
    <h1 class="font-bold mb-5 text-xl text-center text-indigo-950">رابط تأكيد حساب</h1>
    ...
    <p class="mt-20 text-center text-lg">قم بتأكيد حسابك في زميل عبر نسخ الرمز أدناه</p>
    <span class="px-6 py-4 text-4xl tracking-wider bg-indigo-50 text-indigo-500 m-10 rounded-lg">{{ $otp }}</span>
    <p class="text-center text-lg">لا تقم بمشاركة الرمز مع أحد</p>
