...
class RegisterRequest extends BaseRequest
{
    protected $map = [
        ...
        'data.relationships.class.data.id' =>'model.class_id',
    ...
    public function rules(): array
    {
        return [
            ...
            'data.relationships.class.data.id' => 'required_with:data.relationships.class|integer|numeric|exists:groups,id',
